...
public CommonResp<List<DailyTrainSeatQueryResp>> querylist(@Valid DailyTrainSeatQueryReq req){

        List<DailyTrainSeatQueryResp> query = (List<DailyTrainSeatQueryResp>) dailyTrainSeatService.query(req);
