...
import com.example.domain.DailyTrainTicket;
import com.example.domain.DailyTrainTicketExample;
import com.example.domain.Trainstation;
import com.example.enums.SeatTypeEnum;
import com.example.enums.TrainTypeEnum;
import com.example.mapper.DailyTrainTicketMapper;
...
//    @Cacheable(value = "DailyTrainTicketService.query")
    public PageResp<DailyTrainTicketQueryResp> query(DailyTrainTicketQueryReq req) {
        ...
        PageInfo<DailyTrainTicket> pageInfo = new PageInfo<>();
