...
public CommonResp<List<DailyTrainQueryResp>> querylist(@Valid DailyTrainQueryReq req){

        List<DailyTrainQueryResp> query = (List<DailyTrainQueryResp>) dailyTrainService.query(req);
