...
public CommonResp<List<TrainstationQueryResp>> querylist(@Valid TrainstationQueryReq req){

        List<TrainstationQueryResp> query = (List<TrainstationQueryResp>) trainstationService.query(req);
