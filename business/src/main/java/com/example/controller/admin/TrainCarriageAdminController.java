...
public CommonResp<List<TrainCarriageQueryResp>> querylist(@Valid TrainCarriageQueryReq req){

        List<TrainCarriageQueryResp> query = (List<TrainCarriageQueryResp>) trainCarriageService.query(req);
